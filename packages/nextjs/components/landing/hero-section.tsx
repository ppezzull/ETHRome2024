...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative mx-auto mt-32 max-w-7xl px-6 text-center md:px-8">
      <div className="animate-fade-in group inline-flex h-7 -translate-y-4 items-center justify-between gap-1 rounded-full border border-white/5 bg-white/10 px-3 text-xs text-white opacity-0 transition-all ease-in hover:cursor-pointer hover:bg-white/20 dark:text-black">
        <TextShimmer className="inline-flex items-center justify-center">
          <span>✨ Introducing NoteVault</span>{" "}
      ...
      <div className="w-full flex justify-center">
        <PulsatingButton
          ...
          className="whitespace-nowrap animate-fade-in -translate-y-4 gap-1 rounded-lg text-white flex opacity-0 ease-in-out [--animation-delay:600ms] dark:text-black"
        >
